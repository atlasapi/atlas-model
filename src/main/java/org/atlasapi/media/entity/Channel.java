...
public enum Channel implements SelfModelling {
    ...
    BBC_RADIO_LONDON("BBC Radio London", "http://www.bbc.co.uk/services/london", "london"),
    BBC_RADIO_BERKSHIRE("BBC Radio Berkshire", "http://www.bbc.co.uk/services/berkshire", "berkshire"),
    BBC_RADIO_BRISTOL("BBC Radio Bristol", "http://www.bbc.co.uk/services/bristol", "bristol"),
    BBC_RADIO_CAMBRIDGESHIRE("BBC Radio Cambridgeshire", "http://www.bbc.co.uk/services/cambridgeshire", "cambridgeshire"),
    BBC_RADIO_CORNWALL("BBC Radio Cornwall", "http://www.bbc.co.uk/services/cornwall", "cornwall"),
    BBC_RADIO_COVENTRY("BBC Radio Coventry", "http://www.bbc.co.uk/services/coventry", "coventry"),
    BBC_RADIO_CUMBRIA("BBC Radio Cumbria", "http://www.bbc.co.uk/services/cumbria", "cumbria"),
    BBC_RADIO_DERBY("BBC Radio Derby", "http://www.bbc.co.uk/services/derby", "derby"),
    BBC_RADIO_DEVON("BBC Radio Devon", "http://www.bbc.co.uk/services/devon", "devon"),
    BBC_RADIO_ESSEX("BBC Radio Essex", "http://www.bbc.co.uk/services/essex", "essex"),
    BBC_RADIO_GLOUCESTERSHIRE("BBC Radio Gloucestershire", "http://www.bbc.co.uk/services/gloucestershire", "gloucestershire"),
    BBC_RADIO_GUERNSEY("BBC Radio Guernsey", "http://www.bbc.co.uk/services/guernsey", "guernsey"),
    BBC_RADIO_HEREFORDANDWORCESTER("BBC Radio Herefordandworcester", "http://www.bbc.co.uk/services/herefordandworcester", "herefordandworcester"),
    BBC_RADIO_HUMBERSIDE("BBC Radio Humberside", "http://www.bbc.co.uk/services/humberside", "humberside"),
    BBC_RADIO_JERSEY("BBC Radio Jersey", "http://www.bbc.co.uk/services/jersey", "jersey"),
    BBC_RADIO_KENT("BBC Radio Kent", "http://www.bbc.co.uk/services/kent", "kent"),
    BBC_RADIO_LANCASHIRE("BBC Radio Lancashire", "http://www.bbc.co.uk/services/lancashire", "lancashire"),
    BBC_RADIO_LEEDS("BBC Radio Leeds", "http://www.bbc.co.uk/services/leeds", "leeds"),
    BBC_RADIO_LEICESTER("BBC Radio Leicester", "http://www.bbc.co.uk/services/leicester", "leicester"),
    BBC_RADIO_LINCOLNSHIRE("BBC Radio Lincolnshire", "http://www.bbc.co.uk/services/lincolnshire", "lincolnshire"),
    BBC_RADIO_MANCHESTER("BBC Radio Manchester", "http://www.bbc.co.uk/services/manchester", "manchester"),
    BBC_RADIO_MERSEYSIDE("BBC Radio Merseyside", "http://www.bbc.co.uk/services/merseyside", "merseyside"),
    BBC_RADIO_NEWCASTLE("BBC Radio Newcastle", "http://www.bbc.co.uk/services/newcastle", "newcastle"),
    BBC_RADIO_NORFOLK("BBC Radio Norfolk", "http://www.bbc.co.uk/services/norfolk", "norfolk"),
    BBC_RADIO_NORTHAMPTON("BBC Radio Northampton", "http://www.bbc.co.uk/services/northampton", "northampton"),
    BBC_RADIO_NOTTINGHAM("BBC Radio Nottingham", "http://www.bbc.co.uk/services/nottingham", "nottingham"),
    BBC_RADIO_OXFORD("BBC Radio Oxford", "http://www.bbc.co.uk/services/oxford", "oxford"),
    BBC_RADIO_SHEFFIELD("BBC Radio Sheffield", "http://www.bbc.co.uk/services/sheffield", "sheffield"),
    BBC_RADIO_SHROPSHIRE("BBC Radio Shropshire", "http://www.bbc.co.uk/services/shropshire", "shropshire"),
    BBC_RADIO_SOLENT("BBC Radio Solent", "http://www.bbc.co.uk/services/solent", "solent"),
    BBC_RADIO_SOMERSET("BBC Radio Somerset", "http://www.bbc.co.uk/services/somerset", "somerset"),
    BBC_RADIO_STOKE("BBC Radio Stoke", "http://www.bbc.co.uk/services/stoke", "stoke"),
    BBC_RADIO_SUFFOLK("BBC Radio Suffolk", "http://www.bbc.co.uk/services/suffolk", "suffolk"),
    BBC_RADIO_SURREY("BBC Radio Surrey", "http://www.bbc.co.uk/services/surrey", "surrey"),
    BBC_RADIO_SUSSEX("BBC Radio Sussex", "http://www.bbc.co.uk/services/sussex", "sussex"),
    BBC_RADIO_WILTSHIRE("BBC Radio Wiltshire", "http://www.bbc.co.uk/services/wiltshire", "wiltshire"),
    BBC_RADIO_YORK("BBC Radio York", "http://www.bbc.co.uk/services/york", "york"),
    BBC_RADIO_TEES("BBC Radio Tees", "http://www.bbc.co.uk/services/tees", "tees"),
    BBC_RADIO_THREECOUNTIES("BBC Radio Threecounties", "http://www.bbc.co.uk/services/threecounties", "threecounties"),
    BBC_RADIO_WM("BBC Radio Wm", "http://www.bbc.co.uk/services/wm", "wm"),
    BBC_RADIO_RADIO1("BBC Radio Radio1", "http://www.bbc.co.uk/services/radio1/england", "radio1"),
    BBC_RADIO_1XTRA("BBC Radio 1xtra", "http://www.bbc.co.uk/services/1xtra", "1xtra"),
    BBC_RADIO_RADIO2("BBC Radio Radio2", "http://www.bbc.co.uk/services/radio2", "radio2"),
    BBC_RADIO_RADIO3("BBC Radio Radio3", "http://www.bbc.co.uk/services/radio3", "radio3"),
    BBC_RADIO_RADIO4("BBC Radio Radio4", "http://www.bbc.co.uk/services/radio4/fm", "radio4"),
    BBC_RADIO_5LIVE("BBC Radio 5live", "http://www.bbc.co.uk/services/5live", "5live"),
    BBC_RADIO_5LIVESPORTSEXTRA("BBC Radio 5livesportsextra", "http://www.bbc.co.uk/services/5livesportsextra", "5livesportsextra"),
    BBC_RADIO_6MUSIC("BBC Radio 6music", "http://www.bbc.co.uk/services/6music", "6music"),
    BBC_RADIO_RADIO7("BBC Radio Radio7", "http://www.bbc.co.uk/services/radio7", "radio7"),
    BBC_RADIO_ASIANNETWORK("BBC Radio Asiannetwork", "http://www.bbc.co.uk/services/asiannetwork", "asiannetwork"),
    BBC_RADIO_WORLDSERVICE("BBC Radio Worldservice", "http://www.bbc.co.uk/services/worldservice", "worldservice"),
    BBC_RADIO_RADIOSCOTLAND("BBC Radio Radioscotland", "http://www.bbc.co.uk/services/radioscotland/fm", "radioscotland"),
    BBC_RADIO_RADIONANGAIDHEAL("BBC Radio Radionangaidheal", "http://www.bbc.co.uk/services/radionangaidheal", "radionangaidheal"),
    BBC_RADIO_RADIOULSTER("BBC Radio Radioulster", "http://www.bbc.co.uk/services/radioulster", "radioulster"),
    BBC_RADIO_RADIOFOYLE("BBC Radio Radiofoyle", "http://www.bbc.co.uk/services/radiofoyle", "radiofoyle"),
    BBC_RADIO_RADIOWALES("BBC Radio Radiowales", "http://www.bbc.co.uk/services/radiowales/fm", "radiowales"),
    BBC_RADIO_RADIOCYMRU("BBC Radio Radiocymru", "http://www.bbc.co.uk/services/radiocymru", "radiocymru"),
    BBC_RADIO_RADIO4_LW("BBC Radio Radio4 LW", "http://www.bbc.co.uk/services/radio4/lw", "radio4lw"),
