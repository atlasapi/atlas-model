...
public enum Publisher {
    ...
    BARB_MASTER("Barb Master File", "master.barb.co.uk", Countries.GB, SourceStatus.ENABLEABLE, SourceRestriction.ADMIN_ONLY, false),
    BARB_TRANSMISSIONS("Barb Transmissions", "transmissions.barb.co.uk", Countries.GB, SourceStatus.ENABLEABLE, SourceRestriction.ADMIN_ONLY, false)
    ;
