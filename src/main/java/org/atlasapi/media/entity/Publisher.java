...
public enum Publisher {
    ...
    PA("PA", "pressassociation.com", Countries.GB, SourceStatus.ENABLEABLE, SourceRestriction.NONE, false),
    ...
    RADIO_TIMES("Radio Times Film Database", "radiotimes.com", Countries.GB, SourceStatus.UNAVAILABLE, SourceRestriction.NONE, false),
    ...
    YOUVIEW_BT("YouView BT", "bt.youview.com", Countries.GB, SourceStatus.UNAVAILABLE, SourceRestriction.NONE, false),
    YOUVIEW_BT_STAGE("YouView Stage", "stage.bt.youview.com", Countries.GB, SourceStatus.UNAVAILABLE, SourceRestriction.NONE, false),
