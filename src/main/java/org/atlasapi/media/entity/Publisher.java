...
public enum Publisher {
    ...
    HULU("Hulu", "hulu.com", Countries.US, SourceStatus.AVAILABLE_ENABLED, SourceRestriction.NONE),
    YOUTUBE("YouTube", "youtube.com", Countries.ALL, SourceStatus.AVAILABLE_ENABLED, SourceRestriction.NONE),
    TED("TED", "ted.com", Countries.ALL, SourceStatus.AVAILABLE_ENABLED, SourceRestriction.NONE),
    ...
    BLIP("blip.tv", "blip.tv", Countries.ALL, SourceStatus.AVAILABLE_ENABLED, SourceRestriction.NONE), 
    DAILYMOTION("Dailymotion", "dailymotion.com", Countries.ALL, SourceStatus.AVAILABLE_ENABLED, SourceRestriction.NONE), 
    FLICKR("Flickr", "flickr.com", Countries.ALL, SourceStatus.AVAILABLE_ENABLED, SourceRestriction.NONE), 
    FIVE("Five", "five.tv", Countries.GB, SourceStatus.UNAVAILABLE, SourceRestriction.ADMIN_ONLY),
    SEESAW("SeeSaw", "seesaw.com", Countries.GB, SourceStatus.AVAILABLE_ENABLED, SourceRestriction.NONE),
    TVBLOB("TV Blob", "tvblob.com", Countries.IT, SourceStatus.AVAILABLE_ENABLED, SourceRestriction.NONE),
    ICTOMORROW("ICTomorrow", "ictomorrow.co.uk", Countries.GB, SourceStatus.AVAILABLE_ENABLED, SourceRestriction.NONE),
    HBO("HBO", "hbo.com", Countries.US, SourceStatus.AVAILABLE_ENABLED, SourceRestriction.NONE),
    ITUNES("iTunes", "itunes.com", Countries.ALL, SourceStatus.UNAVAILABLE, SourceRestriction.ADMIN_ONLY),
    MSN_VIDEO("MSN Video", "video.uk.msn.com", Countries.GB, SourceStatus.AVAILABLE_ENABLED, SourceRestriction.NONE),
